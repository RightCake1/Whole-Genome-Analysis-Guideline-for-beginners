...
- **2. Annotation**
  ...
  - [Genome Depth](Annotations/Genome_depth.md)

- **3. Identification**
  - [Organism Identification](Identification/Organism_Identification.md)
  - [MLST](Identification/Multi_Locus_Sequence_Type.md)
  - [ANI](Identification/Average_nucleotide_identity.md)
  - [AAI](Identification/Average_Amino_Acid_Identity.md)
